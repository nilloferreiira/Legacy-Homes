...
export function NewsLetterEmail() {
  return (
    <div className="w-full flex flex-col text-center items-center lg:items-end gap-10 bg-shark px-8 md:px-32 py-10 md:py-20 ">
      <div className="text-white w-full lg:w-1/3 flex flex-col text-center lg:text-left items-center justify-center lg:items-end lg:justify-normal gap-7">
